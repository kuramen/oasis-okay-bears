        ...
        .social-links
            a.okb-menusociallink(
                ...
                .logo(:class="`${link.name}-svg`")
                    svg(:width="link.width" :height="link.height" :viewBox="link.viewBox" fill="none" xmlns="http://www.w3.org/2000/svg")
                        path(fill="#bb9772" :d="link.path")
        img.menu-illustration(src="/img/menu_illustration.png" loading="eager" alt="")
</template>
...
export default {
  ...
  data() {
    return {
      ...
      isOverlayOpen: false,
      regularLinks: [
        { name: "home", isDisabled: false, href: "" },
        { name: "bears", isDisabled: true, href: "#" },
        { name: "manifesto", isDisabled: true, href: "#" },
        { name: "roadmap", isDisabled: true, href: "#" },
      ],
      socialLinks: [
        {
          name: "twitter",
